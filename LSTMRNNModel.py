...
#rnn model for actually training 
...
plt.plot(real_price, color="black", label=f"Actual GME Price")
plt.plot(predictedprice, color='green', label=f"Predicted GME Price")
plt.title(f"GME Share Price" )
plt.xlabel('Time')
plt.ylabel(f'GME Share Price')
plt.legend()
plt.show()
